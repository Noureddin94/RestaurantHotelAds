...
namespace RestaurantHotelAds.Application.Services.AdRequestServices
{
    public class AdRequestService : IAdRequestService
    {
        ...
        public AdRequestService(IUnitOfWork unitOfWork, IMapper mapper)
        {
            _unitOfWork = unitOfWork;
            _mapper = mapper;
        }

        public Task<bool> AssignAdToRoomsAsync(AssignAdToRoomsDto dto, Guid userId)
        {
            throw new NotImplementedException();
        }

        public Task<AdRequestDto?> GetAdRequestByIdAsync(Guid id, Guid userId)
        {
            throw new NotImplementedException();
        }

        public Task<IEnumerable<AdRequestDto>> GetHotelAdRequestsAsync(Guid hotelId, Guid userId, string? status = null)
        {
            throw new NotImplementedException();
        }

        public Task<IEnumerable<RoomAdvertisementDto>> GetRoomAdvertisementsAsync(Guid roomId, Guid userId)
        {
            throw new NotImplementedException();
        }

        public Task<bool> RemoveAdFromRoomAsync(Guid roomAdvertisementId, Guid userId)
        {
            throw new NotImplementedException();
        }

        public Task<AdRequestDto> ReviewAdRequestAsync(Guid id, ReviewAdRequestDto dto, Guid userId)
        {
            throw new NotImplementedException();
        }

        //public async Task<IEnumerable<AdRequestDto>> GetHotelAdRequestsAsync(Guid hotelId, Guid userId, string? status = null)
        //{
